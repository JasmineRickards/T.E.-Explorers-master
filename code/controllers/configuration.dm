...
/datum/configuration
	...
	var/vote_autotransfer_initial = 1080000 // Length of time before the first autotransfer vote is called
	var/vote_autotransfer_interval = 800000 // length of time before next sequential autotransfer vote
...
//	var/enable_authentication = 0		// goon authentication
	...
	// Event settings
	var/expected_round_length = 8 * 60 * 60 * 10 // 3 hours
