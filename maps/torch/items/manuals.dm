...
/obj/item/weapon/folder/envelope/captain/LateInitialize()
	...
	<b>TO:</b> Commanding Officer of EV Dagon<br>
...
/obj/item/weapon/paper/umbra
	...
	<b>TO:</b> Commanding Officer of the EV Dagon<br>
	<b>CC:</b> Special Representative aboard the EV Dagon<br>
	...
	<li>Information about this expedition's findings is to be treated as secret and vital to NTF security, and is protected under codeword UMBRA. Crew aboard the EV Dagon are allowed access to this information on a need-to-know basis.</li>
